...
* @Date:   2017-01-12 12:52:09
* @Last Modified by:   sophatvathana
* @Last Modified time: 2017-01-12 13:20:39
*/
#include "response.h"
#include "server.h"
#include "log.h"
...
void Response::write(char * data)
{
    connection()->asyncWrite(data);
}

void Response::raw_write(char * data, int size)
{
    connection()->rawWrite(data, size);
}
