...
namespace StrmrecvWeb {
    ...
    public:
        ...
        std::map<regex_orderable, std::map<std::string, 
            std::function<void(std::shared_ptr<typename ServerBase<socket_type>::Response>, std::shared_ptr<typename ServerBase<socket_type>::Request>)> > > xframe;
        ...
        void sent_frame(const std::shared_ptr<Response> &response){
    ...
    protected:
        ...
        void write_stream(const std::shared_ptr<socket_type> &socket, const std::shared_ptr<Request> &request, 
